...
class Level2Game3 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _Game3();
}

CollectionReference game2_3 = FirebaseFirestore.instance.collection('Game7');
...
class _Game3 extends State<Level2Game3> {
                  ...
                  children: [
                    Container(
                      ...
                      image: DecorationImage(
                        image: AssetImage("asset/bubbleTrouble_2.png"),
                        fit: BoxFit.fill,
                      ),
                    )),
                    Container(
