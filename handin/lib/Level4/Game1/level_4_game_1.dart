...
import 'package:fairytales/Level4/Game1/wands.dart';
...
class Flappy4 extends StatefulWidget {
  @override
  _Flappy4State createState() => _Flappy4State();
}

CollectionReference gameResult_4_1 =
    FirebaseFirestore.instance.collection('Game13');

class _Flappy4State extends State<Flappy4> {
                ...
                actions: <Widget>[
                  ...
                  new FlatButton(
                    ...
                    onPressed: () async {
                      ...
                      int scoring = prefs.getInt("scoreGame13");
                    ...
                    new FlatButton(
                      ...
                      onPressed: () async {
                        ...
                        if (resultString ==
                          ...
                          SharedPreferences prefs =
                              await SharedPreferences.getInstance();
                          prefs.setInt("scoreGame13", score);
                          print(score);
                  ...
                  GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: new BoxDecoration(
                        ...
                        image:
                            new ExactAssetImage("asset/flappybackground_4.png"),
                        fit: BoxFit.cover,
                      )),
                      child: Ship(),
                    ),
...
void playHelp() {
  assetsAudioPlayer.open(Audio("asset/audio/help9.mp3"));
}
