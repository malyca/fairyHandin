...
class Level4Game4 extends StatefulWidget {
  @override
  _Level4Game4 createState() => _Level4Game4();
}

bool callFigure = false;
CollectionReference game4_4 = FirebaseFirestore.instance.collection('Game16');

class _Level4Game4 extends State<Level4Game4> {
  ...
  void _showDialog() {
    CollectionReference game4_4 =
        FirebaseFirestore.instance.collection('Game16');
    showDialog(
