...
class Level4Game3 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _Game3();
}

CollectionReference game4_3 = FirebaseFirestore.instance.collection('Game15');
...
class _Game3 extends State<Level4Game3> {
...
void playHelp() {
  assetsAudioPlayer.open(Audio("asset/audio/help8.mp3"));
}
