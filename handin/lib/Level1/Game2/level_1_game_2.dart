...
CollectionReference game1_2 = FirebaseFirestore.instance.collection('Game2');
...
void playHelp() {
  assetsAudioPlayer.open(Audio("asset/audio/help6.mp3"));
}
