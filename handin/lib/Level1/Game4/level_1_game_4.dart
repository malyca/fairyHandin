...
class Level1Game4 extends StatefulWidget {
  @override
  _Level1Game4 createState() => _Level1Game4();
}

bool callFigure = false;
CollectionReference game1_4 = FirebaseFirestore.instance.collection('Game4');

class _Level1Game4 extends State<Level1Game4> {
