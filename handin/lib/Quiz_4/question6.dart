import 'package:fairytales/Quiz_4/question7.dart';
        ...
        ButtonTheme(
          ...
          child: RaisedButton.icon(
            onPressed: () async {
              ...
              double firstvariable = scale4[random.nextInt(9)].toDouble();
              double secondvariable = 4;
              showDialog(
