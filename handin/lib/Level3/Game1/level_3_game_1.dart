...
import 'package:fairytales/Level3/Game1/wand.dart';
...
class Flappy3 extends StatefulWidget {
  @override
  _Flappy3State createState() => _Flappy3State();
}

CollectionReference gameResult_3_1 =
    FirebaseFirestore.instance.collection('Game9');

class _Flappy3State extends State<Flappy3> {
                ...
                actions: <Widget>[
                  ...
                  new FlatButton(
                    ...
                    onPressed: () async {
                      ...
                      int scoring = prefs.getInt("scoreGame9");
                      ...
                      prefs.remove("scoreGame9");
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SubMenu3(),
                        ),
                      );
                    },
                  )
                  ...
                  GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: new BoxDecoration(
                        ...
                        image:
                            new ExactAssetImage("asset/flappybackground_3.png"),
                        fit: BoxFit.cover,
                      )),
                      child: Ship(),
                    ),
